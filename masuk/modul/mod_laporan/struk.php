...
$pdf->SetX(0.2);
$pdf->SetFont('Arial', 'B', 6);
$pdf->Cell(1.3, 0, 'Pelanggan', 0, 0, 'L');
$pdf->Cell(0.1, 0, ':', 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 6);
...
$pdf->SetX(0.2);
$pdf->SetFont('Arial', 'B', 6);
$pdf->Cell(1.3, 0, 'No Telp/HP', 0, 0, 'L');
$pdf->Cell(0.1, 0, ':', 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 6);
...
while ($r2 = $query->fetch(PDO::FETCH_ASSOC)) {
    ...
    $pdf->Cell(1.3, 0.4, $r2['qty_dtrkasir'], 0, 0, 'R');
