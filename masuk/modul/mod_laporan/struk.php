...
$pdf = new FPDF("P", "cm", array($tinggikertas, 5));
...
//HEADER 1
$pdf->Line(0.2, 2.3, 4.8, 2.3); //horisontal bawah

$pdf->Line(0.2, 4.3, 4.8, 4.3); //judul tabel atas



$pdf->SetY(0.1);
$pdf->SetFont('Arial','B', 10);
$pdf->Cell(4.6, 0.4, $rh['satu'], 0, 1, 'C');
...
$no = 1;
$query = $db->prepare("SELECT * FROM trkasir_detail WHERE kd_trkasir = ? ORDER BY id_dtrkasir ASC");
$query->execute([$_GET['kd_trkasir']]);
